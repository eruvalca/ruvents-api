...
namespace ruvents_api.Controllers
{
    ...
    public class RuventsController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateRuvent(int id, Ruvent ruvent)
        {
            ...
            var currentUser = _context.Users.Where(u => u.PhoneNumber == User.Identity.Name).FirstOrDefault();

            _context.Entry(ruvent).State = EntityState.Modified;
            ruvent.ModifyDate = DateTime.Now;
            ruvent.ModifyBy = currentUser.NickName == null || currentUser.NickName == string.Empty ? currentUser.FirstName : currentUser.NickName;
        ...
        public async Task<ActionResult<Ruvent>> PostRuvent(Ruvent ruvent)
        {
            ...
            ruvent.CreatedBy = currentUser.NickName == null || currentUser.NickName == string.Empty ? currentUser.FirstName : currentUser.NickName;
